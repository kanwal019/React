  ...
  return (
    <main className="menu">
      ...
      {pizzaLength > 0 ? (
        <React.Fragment>
          <p>
            Authentic Italian cuisine. {pizzaLength} creative dishes to choose
  ...
  return (
    <footer className="footer">
      {isOpen ? (
        ...
        <p>
          We're closed now. Please visit us between {openHour}:00 and{" "}
          {closeHour}:00.
        </p>
      )}
    </footer>
...
function Order({ closeHour, openHour }) {
  console.debug({ closeHour, openHour });
  return (
    <div className="order">
      <p>
